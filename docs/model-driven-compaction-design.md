...
> 最后更新：2026-07-23
> 状态：**设计草案，未实施**。下文"当前系统的局限"中部分问题已在 2026-07-26 的 key/value 不变式重构中解决（见 [context-compaction-architecture.md](./context-compaction-architecture.md)）。本文保留作为"模型主动压缩"方向的设计参考，待系统提示词引导成熟后再评估。
