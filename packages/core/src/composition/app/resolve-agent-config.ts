...
import { DEFAULT_MAX_RESULT_SIZE_CHARS, PREVIEW_SIZE_CHARS } from '../../services/config/defaults';
import type { CreateAgentOptions } from './types';
import type { ResolvedAgentConfig, AgentModules } from '../../modules/agent/types';
import type { SessionStateOptions } from '../../modules/session/types';
...
const FIELD_CONSUMERS: Record<string, string[]> = {
  ...
  'behavior.modelAliases': ['extensions/subagents', 'runtime/agent/tools/skill'],
