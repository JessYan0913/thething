...
// ============================================================
// Task Types (data model — used by DataStore interface)
// ============================================================
// These types define the task data model and TaskStore contract.
// Moved here from runtime/tasks/types to eliminate layer inversion.
...
export interface TaskStore {
  ...
  subscribe(listener: (event: { type: string; task: Task; timestamp: number; metadata?: Record<string, unknown> }) => void | Promise<void>): () => void;
