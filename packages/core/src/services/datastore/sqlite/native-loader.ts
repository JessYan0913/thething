...
import type { SqliteDatabase, SqliteDatabaseConstructor } from '../../../primitives/datastore/types';
...
export function loadBetterSqlite3(): SqliteDatabaseConstructor {
  ...
  logger.debug('NativeLoader', `Loading better-sqlite3 from ${packageDir}`)
  ...
  nativeModuleCache.set('better-sqlite3', Database)
  logger.debug('NativeLoader', 'Successfully loaded better-sqlite3 Database class')
