// ============================================================
// Agent Workbench API - Agent 配置 + 调试工作台
// ============================================================
...
// ============================================================
// Config Chat — AI 辅助配置对话
// ============================================================

function createChatHandler(mode: 'config' | 'debug') {
  return async (c: any) => {
    try {
...
function createPatchHandler() {
  return async (c: any) => {
    try {
      const body = await c.req.json() as { conversationId: string; messages: UIMessage[] }
...
app.post('/chat', createChatHandler('config'))
app.get('/chat', createGetHandler())
app.patch('/chat', createPatchHandler())

// Debug chat endpoints
app.post('/debug', createChatHandler('debug'))
app.get('/debug', createGetHandler())
app.patch('/debug', createPatchHandler())
